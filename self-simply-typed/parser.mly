...
/* extended with untyped lambda calculus by adding ctx */
...
Binder :
    /* SLASH / uptyed lambda calculus */
    /* AT use AT(@) to replace SLASH(/) / uptyed lambda calculus */
    /*  { fun ctx -> NameBind } */
    COLON Type
...
Term :
  ...
  | IF Term THEN Term ELSE Term
      ...
      /*{ TmIf($1, $2, $4, $6) }*/
  | LAMBDA LCID COLON Type DOT Term /* lambda x : Nat . x */
       /* simply typed */
      { 
        fun ctx ->
  ...
  | LAMBDA USCORE COLON Type DOT Term /* lambda _ : Nat . 0 */
      /* simply typed */
      {
        fun ctx ->
